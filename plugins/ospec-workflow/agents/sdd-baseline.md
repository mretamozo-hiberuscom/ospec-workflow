...
If you need user input, do NOT ask the user directly. Return `status: blocked` with `question_gate`. The orchestrator will ask the user through `AskUserQuestion` and relaunch you with the answer.
